...
const bundoKanduangData = [
  ...
  },
  {
    id: 2,
    nama: "",
    jabatan: "Wakil Ketua Bundo Kanduang",
    whatsapp: "",
    foto: null,
  },
  {
    id: 3,
    nama: "",
    jabatan: "Sekretaris Bundo Kanduang",
    whatsapp: "",
    foto: null,
  },
  {
    id: 4,
    nama: "",
    jabatan: "Bendahara Bundo Kanduang",
    whatsapp: "",
    foto: null,
  },
];
...
/* ─── Card Komponen ─── */
function PersonCard({ data, index }: { data: typeof bundoKanduangData[0]; index: number }) {
