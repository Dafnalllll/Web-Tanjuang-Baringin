...
export default function Ppid() {
  ...
  return (
    <>
      <Helmet>
        <title>PPID Nagari Tanjuang Baringin</title>

        <meta
          name="description"
          content="Pejabat Pengelola Informasi dan Dokumentasi Nagari Tanjuang Baringin."
        />

        <link rel="canonical" href="https://www.tanjuangbaringin.web.id/ppid" />
      </Helmet>
      <div>
        {/* ════════════════════════════════════════
          HERO
