...
export default function Produk() {
  ...
  return (
    <>
      <Helmet>
        <title>Produk Unggulan Nagari Tanjuang Baringin</title>

        <meta
          name="description"
          content="Produk unggulan dan potensi ekonomi Nagari Tanjuang Baringin Kabupaten Pasaman."
        />

        <link
          rel="canonical"
          href="https://www.tanjuangbaringin.web.id/produk"
        />
      </Helmet>
      <section
        ref={sectionRef}
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    >
                      <img
                        src={
                          item.isDummy ? item.cover : getMediaUrl(item.cover)
                        }
                        alt={item.title}
